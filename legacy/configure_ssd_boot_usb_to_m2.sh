...
usage() {
  ...
  echo
  echo "Script to update system configurations on the M.2 SSD for booting after cloning from USB SSD."
  echo
  echo "Options:"
...
echo "System configurations updated on the M.2 SSD."
echo "You may need to change the boot order to prioritize the SSD in UEFI."
